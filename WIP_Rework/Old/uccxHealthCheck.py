...
commands = [
    ...
    'show uccx jtapi_client version',  # Shows the JTAPI version.
    'show uccx license',  # Shows UCCX License Data
    'show uccx livedata connections',  # Shows livedata connection information
...
def session():
    try:
        ...
        for ipaddr in hostname:
            filename = 'UCCXHealthCheck_' + ipaddr.replace('.', '_') + '_' + timestr
