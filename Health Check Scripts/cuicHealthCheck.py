...
commands = [
    ...
    'show live-data failover',  # Look for "PAIRED-ACTIVE" or "PAIRED-STANDBY"
    'show socketio status',  # We should see this as "ACTIVE"
    'exit'
]
...
def session():
    try:
        ...
        for ipaddr in hostname:
            filename = 'CUICHealthCheck_' + ipaddr.replace('.', '_') + '_' + timestr
