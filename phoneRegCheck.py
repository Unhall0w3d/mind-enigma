...
# Prints the response for registered devices.
# Still working on reporting for not registered devices.
        ...
        try:
            ...
            for response in xmltag:
                if response.attrib['Name'] in devicelist:
                    print('IP Address: ' + response.attrib['IpAddress'],
                          'Device Name: ' + response.attrib['Name'],
                          'Description: ' + response.attrib['Description'],
                          'Registered: ' + response.attrib['Status'])
                    continue
        except requests.exceptions.ConnectionError:
